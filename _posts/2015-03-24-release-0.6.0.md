...
* [on Github](https://github.com/tessera-metrics/tessera/releases/tag/v0.6.1)
...
The [`nvd3`](http://nvd3.org/) renderer, which was previously included for its stream graph support, has been retired. It remains available in the [`extras/`](https://github.com/tessera-metrics/tessera/tree/master/extras) directory of the Github repository.
...
See the
[list of closed issues](https://github.com/tessera-metrics/tessera/issues?q=milestone%3A%22Release+0.6%22+is%3Aclosed)
on github.
